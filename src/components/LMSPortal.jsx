...
import { Upload, Download, FileText, Film, Loader2, Trash2, FolderOpen, BookOpen, AlertCircle } from 'lucide-react'

const BRANCHES = ['CME', 'ECE', 'EEE', 'ME', 'CIVIL', 'ALL']
  ...
  return (
    <div className="space-y-8">
      <header>
        ...
        <p className="text-gray-500 mt-1">{isFaculty ? 'Upload course materials for your students.' : 'Browse your branch resources.'}</p>
      </header>
